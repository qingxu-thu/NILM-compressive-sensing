...
class RNNDisaggregator(Disaggregator):
    ...
    def disaggregate(self, mains, output_datastore, meter_metadata,ep,n, **load_kwargs):
        ...
        **load_kwargs : key word arguments
        ...
        for chunk in mains.power_series(**load_kwargs):
            ...
            appliance_power = self.disaggregate_chunk(chunk2,ep,n)
    ...
    def import_model(self, filename):
        ...
        with h5py.File(filename, 'a') as hf:
            ds = hf.get('D:/project/neural-disaggregator-master/RNN/disaggregator-data').get('mmax')
    ...
    def export_model(self, filename):
        ...
        with h5py.File(filename, 'a') as hf:
            gr = hf.create_group('D:/project/neural-disaggregator-master/RNN/disaggregator-data')
